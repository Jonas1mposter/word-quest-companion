...
import { Award, Banknote, BookOpen, BookOpenCheck, CalendarDays, Coins, Compass, Crown, Flame, Gem, GraduationCap, HandMetal, Heart, Infinity, Library, Lightbulb, Medal, Megaphone, Mountain, Shield, Sparkles, Sprout, Star, Sword, Swords, Target, TrendingUp, Trophy, User, Users, Zap, type LucideIcon } from "lucide-react";

const iconMap: Record<string, LucideIcon> = { Award, Banknote, BookOpen, BookOpenCheck, CalendarDays, Coins, Compass, Crown, Flame, Gem, GraduationCap, HandMetal, Heart, Infinity, Library, Lightbulb, Medal, Megaphone, Mountain, Shield, Sparkles, Sprout, Star, Sword, Swords, Target, TrendingUp, Trophy, User, Users, Zap };
